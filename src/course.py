...
class Course:
    def __init__(self, id: int, name: str, description: str, code: str, end_date: str, start_date: str):
        self.id: int = id
        self.name: str = name
    ...
    def load_courses(self) -> List[Course]:
        try:
            with open(COURSE_FILE, 'r') as file:
                ...
                return [self._create_course_from_dict(course) for course in courses_data]
